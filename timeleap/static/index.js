...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 13) { createjs.Sound.play("end"); return '失敗した 失敗した 失敗した'; }
    if (score <= 30) { createjs.Sound.play("end1"); return "失敗した 失敗した 失敗した"; }
    if (score <= 40) { createjs.Sound.play("end2"); return "失敗した 失敗した 失敗した"; }
    if (score <= 65) { createjs.Sound.play("end3"); return "哐当哐当  新干线"; } { createjs.Sound.play("end4"); return "椎名真有理 是不被需要的"; }
}
